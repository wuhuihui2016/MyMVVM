package com.whh.binder_compiler;

import com.google.auto.service.AutoService;
import com.squareup.javapoet.JavaFile;
import com.whh.mylibrary.annotation.annot.BindView;
...
/**
 * TODO 此处理器并没有生效，未生成java文件
 * apt可以看作是回调:javac在编译时编译到指定的某些注解时的一个回调
 */
...
public class BinderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        for (String key : mCreatorMap.keySet()) {
            ...
            JavaFile javaFile = JavaFile.builder(classCreator.getmPackageName(),
                    classCreator.generateJavaCode()).build();
            try {
